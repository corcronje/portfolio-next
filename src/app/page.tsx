...
export default function Home() {
  return (
    <main className="grid grid-cols-1 lg:grid-cols-12 gap-2 p-2 bg-gray-100 dark:bg-gray-800">
      <aside className="lg:col-span-3">
        <section className="flex flex-col justify-center items-center mt-[100px] bg-gray-400 rounded-md mb-4">
          <Image
            src={ProfileImage}
            width={200}
            height={200}
            alt="Profile Image"
            className="border-gray-100 border-4 rounded-full mt-[-100px]"
          />
          <div className="w-full p-4">
            <h2 className="text-2xl">Cor Cronje</h2>
            ...
            <ul>
              ...
              <li className="css-r5jqub">
                <a href="mailto:cor@phpweb.co.za">cor@phpweb.co.za</a>
              </li>
            </ul>
          </div>
        </section>
                ...
                <div className="css-128ascz">
                  ...
                  <div>
                    <article className="css-hshm0p">
                      ...
                      <div>
                        <span className="css-givedr">
                          Damelin Computer College (Benoni), Mar 2001 – Mar 2001
                        </span>
                      </div>
                    </article>
                  </div>
                  <div>
                    <article className="css-hshm0p">
                      <div className="css-g030ms">
                        <h3 className="css-1v7ceu0">Programming JavaScript</h3>
                      </div>
                      <div>
                        <span className="css-givedr">
                          Damelin Computer College (Benoni), Mar 2001 – Mar 2001
                  ...
                  <div>
                    <article className="css-hshm0p">
                      <div className="css-g030ms">
                        <h3 className="css-1v7ceu0">Good Clinical Practice</h3>
                      </div>
                      <div>
                        <span className="css-givedr">
          ...
          <div className="css-1hqeloq">
            <div className="css-p6tyc6">
              <p>
                ...
                primarily applied myself towards coding robust PHP, and later
                the Laravel applications.
              </p>
              <p>
                I currently work as a senior fullstack developer contractor for
                a very young startup, and previously held various positions as a
              ...
              <p>
                ...
                challenging workouts, and further value spending quality time
              ...
              <form>
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          employer, a prominent public transportation company in
                          the Free State. The front-end was tailored from a
                          theme I bought on ThemeForest. The website does not
                          employ any special plugins, custom plugins, nor custom
                          posts.
                        </p>
                        <p>
                          The content and posts, although bearing my name, was
                          supplied by the client, and uploaded without
                          alteration or spelling and grammar corrections, as per
                          the client's wishes.
                        </p>
                        <p>
                          <a
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          The company did not have any content, no budget, and a
                          very restrictive deadline, hence I assisted the
                          company throughout the entire process, even editing
                          the photos using The Gimp on Linux. The site employs
                          Mailgun for email delivery, SMS Portal for sending SMS
                          notifications, and a reverse charge SMS service
                          supplied by Vodacom.
                        </p>
                        <p>
                          <a
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          special fields and customization in terms of the fonts
                          to meet the client's unique requirements. The website
                          does not employ any special plugins, custom plugins,
                          nor custom posts. The client did not have any usable
                          content and I had to assist the client with
                          copywriting and photos.
                        </p>
                        <p>
                          <a
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        ...
                        <p>
                          ...
                          information from the time of the event to receiving a
                          finalized claim from the insurance companies, this
                          system assist the administrative personnel in tracking
                          and collecting the required information in a
                        ...
                        <p>
                          ...
                          various integrations with other systems in use by the
                          company, such as Sage X3 ERP and Active Directory for
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          electrical geaser setup, and cycle preheated water as
                          and when required.
                        </p>
                        <p>
                          <a
                ...
                <div className="css-6wv7vr">
                  <div className="css-1a63rr6">
                    ...
                    <div className="css-1ho1m2">
                      <h3 className="css-ot75t">Passenger Boarding Bridges</h3>
                      <div className="css-p6tyc6">
                        <p>
                          I was part of a team that built, installed and
                          maintained the passenger boarding bridges at OR Thambo
                          Int. and Cape Town Int. airports. These machines
                          comprise hydraulics, hydro-static drives and electrics
                          that is controlled by PLCs, Scada and linked to the
                          building management system of ACSA's Joint Operations
                          Center.
                        </p>
                        <p>
                          <a
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          controlled baggage handling systems at OR Thambo Int.
                          Airport. Of all the PLC automation projects I was
                          involved with, I would likely rate the baggage
                          handling system at Terminal 6, international
                          departures as the most challenging, since not only did
                          the system comprise almost 2KM in conveyor belts, but
                          each individual parcel is weighed, tracked, X-Rayed,
                          and sorted for loading onto the aircraft.
                        </p>
                        <p>
                          <a
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          aircraft ground power units (GPU). These machines was
                          employed to power the docked aircraft, allowing for
                          the aircraft's auxiliary power unit (APU) to be
                          powered down.
                        </p>
                        <p>
                          <a
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          stand, by means of visual indicators, this allows them
                          to remain clear of obstructions and ensures that
                          aviobridges can reach the aircraft. I was involved
                          from a maintenance perspective, but was not involved
                          with the installation and manufacturing of the system.
                        </p>
                        <p>
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          entailed building and wiring the control cabinets for
                          these vehicle arresting systems. We eventually
                          installed them in and around the airport to secure
                          various vehicle entrances. Following the commissioning
                          of the arrestors, I was involved with maintaining,
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          responsible for managing all IT and telecoms projects,
                          and getting the site ready to accept the workforce.
                          The projects had to be orchestrated and time perfectly
                          to ensure all dependencies and resources was optimally
                          applied towards meeting the deadlines.
                        </p>
                        <p>
                          <a
                            href="https://www.interstate.co.za/"
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          apps I know of that ran Livewire in production. Medbar
                          is a medical records and billing system which allows
                          for accurate patient record keeping and seamless
                          billing against all South African medical schemes, The
                          system also features a lookup service for looking up
                          medical procures and its corresponding rate payable by
                          the patient's medical aid, a complete ICD10 lookup
                          service, and a full featured NAPPI code lookup service
                          for all prescription medication and consumables, thus
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          within the company's depots where there is a potential
                          safety risk towards pedestrians and collision with
                          stationary assets, especially around the refueling
                          points and diesel bowsers.
                        </p>
                        <p>
                          To assist in this regard and as a proof of concept, I
                          developed a digital 433Mhz transmitter beacon powered
                          by a PICAXE microcontroller that can be installed at
                          high risk areas, and a receiver unit that can be
                          fitted to vehicles, which interface with the vehicle's
                          ECU through its CAN bus.
                        </p>
                        <p>
                          When the vehicle's on-board receiver is within a 50 to
                          60 meter radius of the transmitter beacon, and the
                          digitally encrypted token received from the beacon is
                          validated, the receiver triggers a pre-configured limp
                          mode in the vehicle's ECU, thus limiting vehicles top
                          speed to around 15km/h.
                        </p>
                        <p>
                          ...
                          condition in the ECU, an alarm is raised in the ECU's
                          diagnostic logs which is not ideal. We are
                          subsequently in discussions with the engine
                          manufacturer to obtain a customized version of the ECU
                          firmware in which additional software triggers for
                          30km/h and 15km/h among others are present, that when
                          triggered would not raise alarms in the diagnostic
                          logs.
                        </p>
                        <p>
                          <a
                  ...
                  <div className="css-1a63rr6">
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        ...
                        <p>
                          My team and I worked to adding features to the Laravel
                          backend, upgrading Laravel from Laravel v5 to v8, and
                          rebuilding the entire front-end using a new and
                          improved theme.
                        </p>
                        <p>
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          uses the Newland device's NFC, Camera, Laser and other
                          sensors for authenticating pump attendants and
                          ...
                          modules to drive the laser scanner from React Native.
                        </p>
                        <p>
                          <a
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          instead tasked with adding new features and updates to
                          the Laravel backend and Angular front-end, including
                          adding new integrations to services such as Wialon and
                          provisioning the API for the new Android pump
                          controller devices.
                        </p>
                        <p>
                          <a
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          triage bot and a mental health bot. I was provided the
                          Figma designs and had to translate the designs into
                          reusable blade components and views, on Bootstrap 4.6
                    ...
                    <div className="css-1ho1m2">
                      ...
                      <div className="css-p6tyc6">
                        <p>
                          ...
                          triage bot, that allowed patients to be triaged to the
                          correct healthcare professional and best treatment.
                          The front-end is built on Vue.js using Pina and the
                          Local Storage API. The interface being used by several
                          healhcare provides such as Unu Health, Careworx and
                          others as part of their product offering.
                        </p>
                        <p>
                          <a
